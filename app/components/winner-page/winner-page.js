      ...
      var temp = (
        <div className="winner-table">
          <Row className="winner-row">
            ...
            <Col sm={3}><p className="winner-text first">{wl[0][0]}</p><p className="winner-small">School</p></Col>
            <Col sm={3}><p className="winner-text first">{wl[0][1]}</p><p className="winner-small">Team</p></Col>
            <Col sm={3}><p className="winner-text first">&nbsp;&nbsp;{wl[0][2]}</p><p className="winner-small">App</p></Col>
            <Col sm={1}><p className="winner-text first">{wl[0][3]}</p><p className="winner-small">Score</p></Col>
          </Row>
          <Row className="winner-row">
            ...
            <Col sm={3}><p className="winner-text second">{wl[1][0]}</p><p className="winner-small">School</p></Col>
            <Col sm={3}><p className="winner-text second">{wl[1][1]}</p><p className="winner-small">Team</p></Col>
            <Col sm={3}><p className="winner-text second">&nbsp;&nbsp;{wl[1][2]}</p><p className="winner-small">App</p></Col>
            <Col sm={1}><p className="winner-text second">{wl[1][3]}</p><p className="winner-small">Score</p></Col>
          </Row>
          <Row className="winner-row">
            ...
            <Col sm={3}><p className="winner-text third">{wl[2][0]}</p><p className="winner-small">School</p></Col>
            <Col sm={3}><p className="winner-text third">{wl[2][1]}</p><p className="winner-small">Team</p></Col>
            <Col sm={3}><p className="winner-text third">&nbsp;&nbsp;{wl[2][2]}</p><p className="winner-small">App</p></Col>
            <Col sm={1}><p className="winner-text third">{wl[2][3]}</p><p className="winner-small">Score</p></Col>
          </Row>
          <Row className="winner-row">
            ...
            <Col sm={3}><p className="winner-text rest">{wl[3][0]}</p><p className="winner-small">School</p></Col>
            <Col sm={3}><p className="winner-text rest">{wl[3][1]}</p><p className="winner-small">Team</p></Col>
            <Col sm={3}><p className="winner-text rest">&nbsp;&nbsp;{wl[3][2]}</p><p className="winner-small">App</p></Col>
            <Col sm={1}><p className="winner-text rest">{wl[3][3]}</p><p className="winner-small">Score</p></Col>
          </Row>
          <Row className="winner-row">
            ...
            <Col sm={3}><p className="winner-text rest">{wl[4][0]}</p><p className="winner-small">School</p></Col>
            <Col sm={3}><p className="winner-text rest">{wl[4][1]}</p><p className="winner-small">Team</p></Col>
            <Col sm={3}><p className="winner-text rest">&nbsp;&nbsp;{wl[4][2]}</p><p className="winner-small">App</p></Col>
            <Col sm={1}><p className="winner-text rest">{wl[4][3]}</p><p className="winner-small">Score</p></Col>
          </Row>
        </div>
      )
      return temp;
